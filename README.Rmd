...
The simulated data are designed to closely resemble real-world oncology trial data and can be used by researchers as training datasets to develop and test AI-enabled workflows for data processing and TFL automation. The annotated CRFs are stored in the /acrf folder.
...
Assume you want data generated for N=5 patients. 
